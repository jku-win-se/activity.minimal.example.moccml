...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRootAccess().getActivitiesAssignment_4_2(), "rule__Root__ActivitiesAssignment_4_2");
			builder.put(grammarAccess.getRootAccess().getActivitiesAssignment_4_3_1(), "rule__Root__ActivitiesAssignment_4_3_1");
			builder.put(grammarAccess.getActivityAccess().getNameAssignment_2(), "rule__Activity__NameAssignment_2");
			builder.put(grammarAccess.getActivityAccess().getSequencesAssignment_4_2(), "rule__Activity__SequencesAssignment_4_2");
			builder.put(grammarAccess.getActivityAccess().getSequencesAssignment_4_3_1(), "rule__Activity__SequencesAssignment_4_3_1");
