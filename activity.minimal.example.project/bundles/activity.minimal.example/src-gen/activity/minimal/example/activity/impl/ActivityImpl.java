 ...
 * </p>
 * <ul>
 *   <li>{@link activity.minimal.example.activity.impl.ActivityImpl#getSequences <em>Sequences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityImpl extends NamedElementImpl implements Activity {
	...
	public EList<Sequence> getSequences() {
		if (sequences == null) {
			sequences = new EObjectContainmentEList<Sequence>(Sequence.class, this,
					ActivityPackage.ACTIVITY__SEQUENCES);
		}
		return sequences;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ActivityPackage.ACTIVITY__SEQUENCES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case ActivityPackage.ACTIVITY___START_ACTIVITY:
			startActivity();
			return null;
		}
