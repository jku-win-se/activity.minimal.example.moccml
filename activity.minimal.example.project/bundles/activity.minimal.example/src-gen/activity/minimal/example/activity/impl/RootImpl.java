 ...
 * </p>
 * <ul>
 *   <li>{@link activity.minimal.example.activity.impl.RootImpl#getActivities <em>Activities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends NamedElementImpl implements Root {
	...
	public EList<Activity> getActivities() {
		if (activities == null) {
			activities = new EObjectContainmentEList<Activity>(Activity.class, this, ActivityPackage.ROOT__ACTIVITIES);
		}
		return activities;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ActivityPackage.ROOT__ACTIVITIES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case ActivityPackage.ROOT___MAIN:
			main();
			return null;
		}
